...
# ###Tactic 1.1: write clear and specific instructions is to use delimiters to clearly indicate distinct parts of the input
...
# ###Tactic 1.2: ask for a structured output
#                JSON, HTML
...
# ###Tactic 1.3: Ask the model to check whether conditions are satisfied
